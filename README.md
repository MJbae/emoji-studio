...
| **4. 이모지 생성**     | 45개 이모지 아이디어를 자동 생성한 뒤 3개씩 병렬로 이미지 생성 (약 15~25분)             |
...
이미 만들어둔 이모지가 있다면 생성 과정을 건너뛸 수 있습니다.
...
| 플랫폼      | 이모지 크기 | 포함 파일                   |
| ----------- | ----------- | --------------------------- |
| OGQ 이모지  | 740 x 640   | tab.png + main.png + 이모지 |
| LINE 이모지 | 370 x 320   | tab.png + main.png + 이모지 |
| LINE Emoji  | 180 x 180   | tab.png + 이모지            |
